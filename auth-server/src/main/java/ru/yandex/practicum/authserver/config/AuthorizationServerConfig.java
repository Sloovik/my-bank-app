...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient frontApp = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("front-app")
                .clientSecret("{noop}front-secret")
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
                .redirectUri("http://localhost:8080/login/oauth2/code/front-app")
        ...
        RegisteredClient accountsService = RegisteredClient.withId(UUID.randomUUID().toString())
        ...
        return new InMemoryRegisteredClientRepository(frontApp, accountsService, cashService, transferService);
    }
